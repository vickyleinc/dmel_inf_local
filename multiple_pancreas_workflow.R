...
celseq.data <- read.table("~/Downloads/Data/pancreas_multi_celseq_expression_matrix.txt.gz")
celseq2.data <- read.table("~/Downloads/Data/pancreas_multi_celseq2_expression_matrix.txt.gz")
fluidigmc1.data <- read.table("~/Downloads/Data/pancreas_multi_fluidigmc1_expression_matrix.txt.gz")
smartseq2.data <- read.table("~/Downloads/Data/pancreas_multi_smartseq2_expression_matrix.txt.gz")
